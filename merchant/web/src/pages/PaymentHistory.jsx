...
class PaymentHistory extends React.Component {
  ...
  componentWillMount() {
    fetch('http://47.243.16.81:8000/payment_history')
      .then((res) => res.json())
      .then((res) => {
        this.setState({
          list: res.data.res,
  ...
  onSearchClick = () => {
    fetch('http://47.243.16.81:8000/search_payment_history', { method: 'post', body: JSON.stringify({ address: this.searchAddress.value }) })
      .then((res) => res.json())
      .then((res) => {
        this.setState({
          list: res.data.res,
